...
install_ss_panel(){
	...
	install_soft_for_each
	wget -c https://raw.githubusercontent.com/sunyi369/ss-panel-and-ss-py-mu/master/lnmp1.3.zip && unzip lnmp1.3.zip && cd lnmp1.3 && chmod +x install.sh && ./install.sh lnmp
	chattr -i /home/wwwroot/default/.user.ini
	rm -rf /home/wwwroot/default
	git clone https://github.com/sunyi369/ss-panel.git "/home/wwwroot/default"
...
install_ss_py_mu(){
	...
	install_soft_for_each(){
		...
		if [[ ${release} = "centos" ]]; then
			...
			curl https://raw.githubusercontent.com/sunyi369/ss-panel-and-ss-py-mu/master/get-pip.py -o get-pip.py
			python get-pip.py
	...
	git clone https://github.com/sunyi369/shadowsocks-py-mu.git "/root/shadowsocks-py-mu"
	#modify Config.py
